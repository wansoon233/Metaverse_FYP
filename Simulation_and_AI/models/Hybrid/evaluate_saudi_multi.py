...
RESULT_DIR = "results_saudi"
CSV_NAME = "hybrid_saudi_multi_seed_results.csv"
...
def main():
    print("="*60)
    print("🌍 AUTOMATED ZERO-SHOT SAUDI EVALUATION (10 SEEDS)")
    print("="*60)
    ...
    for seed in SEEDS:
        print(f"🔹 Dropping Seed {seed} into the Desert...", end=" ", flush=True)
        ...
        # 2. Set up environment WITH SAUDI WEATHER
        ...
        for _ in range(TIMESTEPS_TEST):
            ...
            # Count Violations (Hard Limits: 23.0 to 26.0)
            ...
            if current_temp < 23.2 or current_temp > 25.8:
                ...
                # Call predict just to keep the LSTM memory updated, even though we override
        ...
        print(f"Done! (Violations: {comfort_violations})")
    ...
    print("\n" + "═"*60)
    print(f"✅ SAUDI ARABIA ZERO-SHOT TEST COMPLETE.")
