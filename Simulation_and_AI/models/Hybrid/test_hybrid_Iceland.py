...
ICELAND_WEATHER_PATH = '/home/wansoon/Desktop/FYP_Metaverse/sinergym_source/sinergym/data/weather/Iceland.epw' 
TIMESTEPS_TEST = 35040 

MODEL_DIR = "models/Hybrid/saved_models"  
RESULT_DIR = "models/Hybrid/results_iceland"
MODEL_NAME = "ppo_lstm"
CSV_NAME = "hybrid_results_iceland.csv"
...
def main():
    print("="*60)
    print("🚀 RUNNING ICELAND-SPECIALIST HYBRID TEST")
    print("="*60)
    
    env = gym.make(ENV_NAME, weather_files=ICELAND_WEATHER_PATH)
