...
JAPAN_WEATHER_PATH = '/home/wansoon/Desktop/FYP_Metaverse/sinergym_source/sinergym/data/weather/JPN_Tokyo.Hyakuri.477150_IWEC.epw' 
...
def main():
    print("="*60)
    print("🚀 RUNNING JAPAN-SPECIALIST HYBRID TEST")
    print("="*60)
    
    env = gym.make(ENV_NAME, weather_files=JAPAN_WEATHER_PATH)
