...
Egypt_WEATHER_PATH = '/home/wansoon/Desktop/FYP_Metaverse/sinergym_source/sinergym/data/weather/Egypt.epw' 
TIMESTEPS_TEST = 35040 

MODEL_DIR = "models/Hybrid/saved_models"  
RESULT_DIR = "models/Hybrid/results_Egypt"
MODEL_NAME = "ppo_lstm"
CSV_NAME = "hybrid_results_Egypt.csv"
...
def main():
    print("="*60)
    print("🚀 RUNNING EGYPT-SPECIALIST HYBRID TEST")
    print("="*60)
    
    env = gym.make(ENV_NAME, weather_files=Egypt_WEATHER_PATH)
