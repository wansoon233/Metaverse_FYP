...
TOKYO_WEATHER = '/home/wansoon/Desktop/FYP_Metaverse/sinergym_source/sinergym/data/weather/JPN_Tokyo.Hyakuri.477150_IWEC.epw'
TIMESTEPS_TEST = 35040 
MODEL_PATH = "/home/wansoon/Desktop/FYP_Metaverse/models/Hybrid/saved_models/ppo_lstm.zip"

print("="*60)
print("🏙️  TOKYO ABLATION STUDY (SEASONAL CLIMATE TEST)")
print("="*60)
...
def run_ablation(config_name, use_lstm, use_shield):
    print(f"\n⏳ Testing: {config_name}")
    env = gym.make(ENV_NAME, weather_files=TOKYO_WEATHER)
