...
# 2. Path Setup
RESULT_DIR = "models/PID/results_kl"
CSV_NAME = "pid_results_kl.csv"

# Ensure Output folder exists
os.makedirs(RESULT_DIR, exist_ok=True)

# ==========================================
# 1. PID CONTROLLER CLASS (EXACT SAME)
# ==========================================
class PIDController:
...
def main():
    print("="*60)
    print("🚀 TESTING PID GENERALIZATION: KUALA LUMPUR")
    ...
    print("\n" + "═"*40)
    print("        🏆 PID RESULTS (KUALA LUMPUR)")
    print("═"*40)
